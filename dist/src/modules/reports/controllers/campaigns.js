...
const getCampaignsReport = async (req, res) => {
    try {
        ...
        const hasCampaignTypeFilter = typeof campaign_type === 'string' && campaign_type.trim();
        ...
        const byTypeQuery = (0, connection_1.db)('campaigns');
        if (typeof name === 'string' && name.trim()) {
...
exports.getCampaignsReport = getCampaignsReport;
