...
const createProduct = async (req, res) => {
    try {
        const validation = schemas_1.createProductSchema.safeParse(req.body);
        ...
        const existingProduct = await (0, connection_1.db)('products')
        ...
        const [id] = await (0, connection_1.db)('products').insert(data);
        const product = await (0, connection_1.db)('products').where({ id }).first();
